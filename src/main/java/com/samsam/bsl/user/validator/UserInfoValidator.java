...
public class UserInfoValidator {
	...
	public UserInfoValidator(UserRepository userRepository) {
	 ...
	 // 회원가입 유효성 검사 (아이디, 비밀번호, 이메일, 닉네임, 연락처에 대한 유효성 검사)
	  public Map<String, String> getValidMessage(UserDTO userDTO, Errors errors) {
	...
	// 아이디 중복 검사
	public String idDueCheck(UserDTO userDTO) {
		if (checkUsernameDuplicate(userDTO.getUsername())) {
	...
	// 닉네임 중복 검사
	public String nickDueCheck(UserDTO userDTO) {

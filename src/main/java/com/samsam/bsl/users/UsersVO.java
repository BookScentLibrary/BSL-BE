...
public class UsersVO {
	...
	private String gender;//성별 Woman/Man
	private String userBirth;//생년월일 2000/01/01
	private int userAge;//나이 12
	private int permission;//권한 0 : 일반 유저/1 : 사서/ 2 : 관리자
	
	//생성자
	public UsersVO(String userId, String username, String password, String email, String nickname, String phone,
